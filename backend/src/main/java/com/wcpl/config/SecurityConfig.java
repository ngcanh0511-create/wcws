...
import com.wcpl.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/activity-feed").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/v1/hall-of-fame").permitAll()
